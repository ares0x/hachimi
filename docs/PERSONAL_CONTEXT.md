# Personal Context Architecture (SOUL + TELOS + Knowledge Base)
...
├─────────────────────────────────────────────────────────────────────────────┤
│ Tier 3 — Personal Knowledge Base (knowledgeRoot)                          │
...
| `knowledgeRoot` | User configured | Read-only personal knowledge base root |
| `knowledgeWriteRoot` | `knowledgeRoot/_inbox` | Write-allowed folder inside knowledge base |

### PathJail Rules
1. **`workspaceRoot`**: Full read-write access for active coding project.
2. **`knowledgeRoot`**: Read-only access for knowledge base notes.
