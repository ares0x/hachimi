...
/** Recovery hint appended when a long-running tool (per-tool timeoutMs override) times out */
export function formatLongRunningTimeoutHint(): string {
  return i18n().t("tool.long_running_timeout_hint");
}
